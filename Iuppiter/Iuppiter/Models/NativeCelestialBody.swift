...
struct NativeCelestialBody: Identifiable, Equatable {
    ...
    let isMajor: Bool
    let assetTier: String // "real" | "partial-real" | "procedural"
}
...
extension RawBody {
    ...
    static func planet(
        ...
        argumentOfPeriapsisDegrees: Double = 0.0,
        meanAnomalyAtEpochDegrees: Double = 0.0,
        referencePlane: String = "ECLIPTIC",
        textureName: String,
        color: Color,
        axialTilt: Float,
